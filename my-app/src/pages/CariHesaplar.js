...
const CariHesaplar = () => {
  ...
  const filteredData = data.filter(item => {
    ...
    const columns = [
      { title: 'Kullanıcı Adı', dataIndex: 'username', key: 'username', sorter: (a, b) => (a.username || '').localeCompare(b.username || '') },
      { title: 'E-posta', dataIndex: 'email', key: 'email', sorter: (a, b) => (a.email || '').localeCompare(b.email || '') },
      { title: 'Kullanıcı Tipi', dataIndex: 'userTypeName', key: 'userTypeName', sorter: (a, b) => (a.userTypeName || '').localeCompare(b.userTypeName || '') },
      { title: 'Cari Grup', dataIndex: 'accountGroupName', key: 'accountGroupName', sorter: (a, b) => (a.accountGroupName || '').localeCompare(b.accountGroupName || '') },
      { title: 'Site', dataIndex: 'siteName', key: 'siteName', sorter: (a, b) => (a.siteName || '').localeCompare(b.siteName || '') },
      { title: 'Firma', dataIndex: 'firmName', key: 'firmName', sorter: (a, b) => (a.firmName || '').localeCompare(b.firmName || '') },
      { title: 'Firma Kısa Adı', dataIndex: 'companyShortName', key: 'companyShortName', sorter: (a, b) => (a.companyShortName || '').localeCompare(b.companyShortName || '') },
      { title: 'Proje', dataIndex: 'projectName', key: 'projectName', sorter: (a, b) => (a.projectName || '').localeCompare(b.projectName || '') },
      { title: 'Yetkili Personel', dataIndex: 'authorizedPersonnel', key: 'authorizedPersonnel', sorter: (a, b) => (a.authorizedPersonnel || '').localeCompare(b.authorizedPersonnel || '') },
      ...
      { title: 'Adres', dataIndex: 'address', key: 'address', sorter: (a, b) => (a.address || '').localeCompare(b.address || '') },
      { title: 'Vergi No', dataIndex: 'taxNumber', key: 'taxNumber', sorter: (a, b) => (a.taxNumber || '').localeCompare(b.taxNumber || '') },
      { title: 'TC Kimlik No', dataIndex: 'tcIdentityNo', key: 'tcIdentityNo', sorter: (a, b) => (a.tcIdentityNo || '').localeCompare(b.tcIdentityNo || '') },
